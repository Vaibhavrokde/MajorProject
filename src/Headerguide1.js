...
export default function Headerguide1() {
      ...
      <div>
            ...
            <Navbar.Collapse id="basic-navbar-nav" inline>
                <Nav className="ml-auto d-flex justify-content-end" >
                    ...
                    <DropdownButton title={localStorage.getItem("CurrentSession") && JSON.parse(localStorage.getItem("CurrentSession")).username} id="dropdown-menu-align-right" class="dropdown bg-grey mr-2">
