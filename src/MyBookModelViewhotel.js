...
function MyBookModelViewhotel(props) {
  ...
  const postDatatoServer= (data)=> {
    axios.post(`http://localhost:8080/hotelbooking/deletehotelbook`,data ).then(
      (response)=>{
    ...
    <>
      ...
      <Modal show={show} onHide={handleClose} style={{color: 'black'}}>
        ...
        <Modal.Body>
          ...
          <p><strong>Guide Id: </strong>{props.itemData.hotel_id}</p>
          <p><strong>Guide Name: </strong>{props.itemData.hotel_name}</p>
...
export default MyBookModelViewhotel;